...
# TODO REMOVE - ljakubow
export FLUENTIMAGE=arointsvc.azurecr.io/fluentbit:1.7.8-1
...
cat >/etc/sysconfig/fluentbit <<'EOF'
...
ExecStartPre=-/usr/bin/docker pull $FLUENTIMAGE
